...
public class MovieSystem {
    ...
    /**
          5. 定义一个静态的User类型的变量记住当前登录成功的用户对象
     */
    ...
    private static void login(){
        while (true){
            ...
            if(u != null){
                ...
                System.out.println("登录名称错误，请重新确认！");
            }
        }
    }
    ...
    private static void showBusinessInfos(){
        ...
        LOGGER.info(loginUser.getUserName() + "商家，正在看自己的详细页面：");
        ...
        if(movies.size() > 0){
            ...
            for (Movie movie: movies) {
                System.out.println(movie.getName()+"\t\t\t" + movie.getActor() + "\t\t" + movie.getTime()
                        + "\t\t" + movie.getScore() + "\t\t" + movie.getStartTime() + "\t\t" + movie.getPrice() + "\t\t" + movie.getNumber()
    ...
    private static void buyMovie(){
        ...
        while(true){
            ...
            if(business == null){
                System.out.println("对不起，没有该店铺！请重新确认。");
            }else{
                // 2. 此商家全部的排片
                List<Movie> movies = ALL_MOVIES.get(business);
                // 3. 判断是否存在上映的电影
                if(movies.size() > 0){
                    ...
                    while(true){
                        ...
                        if(movie != null){
                            ...
                            System.out.println("电影名称有问题，请重新确认！");
                        }
                    }
                }else{
